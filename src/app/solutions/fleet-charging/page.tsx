...
const solution = getSolutionBySlug("fleet-charging")!;
const related = solutions.filter((s) => s.slug !== solution.slug);

export const metadata: Metadata = {
  title: solution.metaTitle,
  description: solution.description,
  alternates: { canonical: "/solutions/fleet-charging" },
};

export default function FleetChargingPage() {
  return (
    <main className="bg-[#03110d]">
      <Breadcrumbs items={[{ name: "Solutions", url: "/solutions" }, { name: solution.title, url: "/solutions/fleet-charging" }]} />
      <PageHero eyebrow="Fleet Charging" title={solution.title} description={solution.description} />
      ...
      <section className="relative pb-14 sm:pb-16">
        <Container>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <PrimaryButton href="/contact">Discuss Fleet Charging</PrimaryButton>
            <Link
