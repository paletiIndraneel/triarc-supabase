...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/solutions/charger-installation" },
};

export default function ChargerInstallationPage() {
  return (
    <main className="bg-[#03110d]">
      <Breadcrumbs items={[{ name: "Solutions", url: "/solutions" }, { name: solution.title, url: "/solutions/charger-installation" }]} />
      <PageHero eyebrow="Charger Installation" title={solution.title} description={solution.description} />
      ...
      <section className="relative pb-14 sm:pb-16">
        <Container>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <PrimaryButton href="/contact">Discuss Charger Installation</PrimaryButton>
            <Link
