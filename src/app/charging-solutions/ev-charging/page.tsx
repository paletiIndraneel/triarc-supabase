...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/charging-solutions/ev-charging" },
};
    ...
    <main className="bg-[#03110d]">
      <Breadcrumbs
        items={[
          ...
          { name: solution.title, url: "/charging-solutions/ev-charging" },
        ]}
      />
      <PageHero eyebrow="EV Charging" title={solution.title} description={solution.metaDescription} />
