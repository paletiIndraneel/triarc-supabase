...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/charging-solutions/dc-fast-charging" },
};
    ...
    <main className="bg-[#03110d]">
      <Breadcrumbs
        items={[
          ...
          { name: solution.title, url: "/charging-solutions/dc-fast-charging" },
        ]}
      />
      <PageHero eyebrow="DC Fast Charging" title={solution.title} description={solution.metaDescription} />
