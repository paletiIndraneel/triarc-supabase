...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/charging-solutions/fleet-charging" },
};
    ...
    <main className="bg-[#03110d]">
      <Breadcrumbs
        items={[
          ...
          { name: solution.title, url: "/charging-solutions/fleet-charging" },
        ]}
      />
      <PageHero eyebrow="Fleet Charging" title={solution.title} description={solution.metaDescription} />
