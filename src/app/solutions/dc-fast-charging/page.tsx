...
const solution = getSolutionBySlug("dc-fast-charging")!;
const related = solutions.filter((s) => s.slug !== solution.slug);

export const metadata: Metadata = {
  title: solution.metaTitle,
  description: solution.description,
  alternates: { canonical: "/solutions/dc-fast-charging" },
};

export default function DcFastChargingPage() {
  return (
    <main className="bg-[#03110d]">
      <Breadcrumbs items={[{ name: "Solutions", url: "/solutions" }, { name: solution.title, url: "/solutions/dc-fast-charging" }]} />
      <PageHero eyebrow="DC Fast Charging" title={solution.title} description={solution.description} />
